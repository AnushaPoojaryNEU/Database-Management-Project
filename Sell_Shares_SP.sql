--------------------------------------------------------
--  DDL for Procedure SELL_SHARES
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "ADMIN"."SELL_SHARES" (
...
select QTY into p_stock_avail from CUSTOMERHOLDING WHERE SECURITYID=P_STOCK_ID;
